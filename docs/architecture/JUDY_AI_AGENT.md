...
- **⏰ 맥락 인지 스마트 리마인더 & 업무 트래킹** `🟡 부분 개발 완료 (2026-02-24)`:
  - ✅ **[개발 완료] 업무 시간 트래킹 MVP**: 업무 상태를 진행중→완료로 변경 시 시작/종료 시간을 자동 기록하고 소요 시간(분)을 계산. 관리자(송용남, 정혜림) 전용 대시보드에서 개별 업무 소요 시간 뱃지(`⏱️ Nh Mm 소요`) 및 오늘 총 몰입 시간 카드(`🔥 오늘의 몰입`) 확인 가능.
  - ⬜ **[미개발] 스마트 리마인더**: 마감 임박 업무나 3일 이상 방치된 업무를 감지해 "넛지(Nudge)" 알림 발송 기능은 향후 개발 예정.
  - ⬜ **[미개발] 주간/월간 시각화**: 대시보드에서 프로젝트별 시간 소요 파이 차트 등 통계 시각화는 향후 확장 예정.
