...
- **[Task 1.1]** V4 시스템 통합 아키텍처 및 API 명세서 작성
  - **담당자**: 👨‍💻 **알렉스 (Tech Lead)**
  - **세부내용**: `state.json` 구조 설계, 동시성(LockService) 제어 방안, 이벤트 기반 Webhook 구조 설계
- **[Task 1.2]** 개발/QA 간 핑퐁 통신 프로토콜 정의
  - **담당자**: 🤵 **자비스 PO** & 👨‍💻 **알렉스**
...
- **[Task 2.1]** 기존 구글 시트 트리거 로직 제거 및 Webhook 리스너 구현
  - **담당자**: 👩‍💻 **에이다 (Backend Dev)**
  - **세부내용**: 하네스 이벤트 감지 API 엔드포인트 생성 (`agent_sync.gs` 리팩토링)
- **[Task 2.2]** `state.json` 읽기/쓰기 모듈 및 `session_handoff` 객체 구현
  - **담당자**: 👩‍💻 **에이다 (Backend Dev)**
...
- **[Task 5.1]** 프론트-백엔드 데이터 연동 테스트 및 버그 픽스
  - **담당자**: 👨‍💻 **알렉스** (아키텍처/코드 병합 리뷰), 👩‍💻 **에이다**, 👧 **클로이**
- **[Task 5.2]** V4 핑퐁 시스템 V1.0 최초 릴리즈 및 꼼꼼이 팀(문서화) 이관
  - **담당자**: 🤵 **자비스 PO**
